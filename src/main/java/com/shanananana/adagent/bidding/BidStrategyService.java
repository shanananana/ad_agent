...
/**
 * 出价策略<strong>查询门面</strong>：按人群×时段×设备读取 {@link com.shanananana.adagent.bidding.dto.BaseBidModelFile} 与
 * {@link com.shanananana.adagent.bidding.dto.CoefficientsFile}，计算生效价 B×α；本仓库不设 RTB 实时竞价，仅供演示或后续扩展。
 */
@Service
