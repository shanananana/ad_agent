...
import com.shanananana.adagent.data.dto.ContentCatalogFile;
...
/**
 * <strong>内容库</strong> JSON 仓库：按用户读写 {@code contents.json}，与 {@link com.shanananana.adagent.data.AdDataRepository} 使用相同 base 目录约定。
 */
@Repository
