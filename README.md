...
- 实验页 **文生图（通义万相）**：[http://localhost:8081/creative-gen.html](http://localhost:8081/creative-gen.html)（需 `spring.ai.model.image=dashscope` 与 DashScope `api-key`）
...
![对话 Agent](./docs/images/chatAgent.png)

</details>

<details open>
<summary><strong>文生图 · 自动根据内容生成prompt+素材图</strong>（点击隐藏截图）</summary>

![对话页-计划与结构树](./docs/images/text_2_png.png)
...
│   └── images/                          # README 配图（对话页截图：chatAgent / 计划查看 / 调价日志）
